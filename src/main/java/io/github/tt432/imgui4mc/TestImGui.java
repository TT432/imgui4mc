 ...
 */
@RegisterImGui
public class TestImGui implements ImGuiWindowElements {
    private boolean bool;
    private boolean openTest;

    ImBoolean imBoolean = new ImBoolean(bool);
    ImBoolean openTestBoolean = new ImBoolean(openTest);
    ...
    public void process(Window window) {
        if (ImGui.checkbox("openTest", openTestBoolean)) {
            openTest = openTestBoolean.get();
        }
